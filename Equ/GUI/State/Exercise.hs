...
-- | Se puede usar el botón para ver las posibles reescrituras?
showChoicesButton :: IState Bool
showChoicesButton = getExercise >>=
                    maybe (return True) (return . (== List) . eConfRewriteMode . exerConf)
